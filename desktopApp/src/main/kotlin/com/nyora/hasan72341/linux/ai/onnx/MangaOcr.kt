...
object MangaOcr {
    ...
    private fun ensureLoaded() {
        ...
        synchronized(this) {
            if (encoder != null && decoder != null && vocab != null) return
            val encFile = OnnxModels.verifiedModelFile(ENCODER_SHA256)
            val decFile = OnnxModels.verifiedModelFile(DECODER_SHA256)
            val vocFile = OnnxModels.verifiedModelFile(VOCAB_SHA256)
